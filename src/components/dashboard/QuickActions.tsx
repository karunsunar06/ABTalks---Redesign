    ...
    <section className="animate-rise" style={{ animationDelay: "280ms" }}>
      ...
      <div className="mt-3 grid grid-cols-2 gap-3">
        {actions.map(({ label, icon: Icon }) => (
          <button
            key={label}
            className="flex flex-col items-start gap-3 rounded-2xl border border-border bg-card p-4 text-left shadow-soft transition-all duration-200 hover:bg-secondary active:scale-[0.97]"
          >
